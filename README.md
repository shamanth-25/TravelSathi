# 🗺️ TravelSathi (ప్రయాణ తోడు / यात्रासाथी)
...
- Python 3.9+
- Streamlit
- (Optional) Ollama installed and running locally for Offline Inference
...
4. Enter your personal API Key / token:
   - For **Groq**, input your Groq API key (uses `llama-3.1-8b-instant`).
   - For **Gemini**, input your Google AI studio developer key (uses `gemini-1.5-flash`).
